...
export default function PreviewForm() {
        ...
        return (
          <div className="space-y-2">
            {field.options?.map((option, idx) => (
              <label key={idx} className="flex items-center gap-2 text-white">
                <input
                  type="radio"
                  name={nameAttr}
                  value={option}
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen">
      ...
      <div
        className={`border shadow-lg p-6 rounded bg-gray-800 overflow-hidden break-words ${
          viewMode === "mobile"
      ...
      >
        <div className="max-w-3xl mx-auto p-6">
          ...
          <p className="text-lg leading-relaxed text-gray-300 mb-8 whitespace-pre-wrap break-words max-w-3xl mx-auto">
            {formDescription}
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {fields.map((field, idx) => (
              <div
                key={field.id}
                className="border border-gray-700 bg-gray-800 rounded-md p-4 shadow-sm space-y-2"
              >
